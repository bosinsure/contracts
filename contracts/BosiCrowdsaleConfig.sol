...
contract BosiCrowdsaleConfig  {
    ...
    uint256 public constant CONTRIBUTION_MAX_NO_WHITELIST  = 22 ether;    // maximum acceptable contribution without whitelisting
    uint256 public constant HARDCAP                   =  42858 ether;
    uint256 public constant SOFTCAP                   =  4286 ether;
    ...
    uint256 public constant TOKENS_PER_ETHER       = 910; // 10**(uint256(18));
