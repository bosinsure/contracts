...
const CrowdsaleMock = artifacts.require('BosiCrowdsaleMock');
const BosiToken = artifacts.require('BosiToken');

contract('BosiCrowdsale', function ([_, owner, investor, wallet, purchaser, thirdparty]) {
  ...
  var BosiTokenSaleInstance = Crowdsale.at(Crowdsale.address);
  ...
  beforeEach(async function () {
    ...
    this.token = BosiToken.at(await this.crowdsale.token());
  });

  it('should be token owner by default', async function () {
    const owner = await BosiTokenInstance.owner();
    owner.should.equal(BosiTokenSaleInstance.address);
  });
